...
class TrtYOLOv3(object):
    ...
    def __init__(self, model, input_shape, category_num=80):
        ...
        if 'tiny' in model:
            postprocessor_args = {
                ...
                'yolo_anchors': [(0.81,1.37), (1.64,3.59), (3.41,5.17), (3.87,9.51), (7.53,10.45), (14.20,14.38)],
            ...
            postprocessor_args = {
                ...
                'yolo_anchors': [(1.16,2.48), (2.71,4.46), (3.40,9.37),
                                 (6.05,12.82), (7.17,6.03), (9.47,9.79),
                                 (10.19,15.03), (14.78,10.34), (15.63,16.11)],
                # Threshold for non-max suppression algorithm, float
                # value between 0 and 1
                # between 0 and 1
                'nms_threshold': 0.5,
    ...
    def detect(self, img, conf_th=0.3):
        ...
        shape_orig_WH = (640, 480) # -mc changed image size
